    ...
    <div className='border-b border-neutral-900 pb-4'>
      ...
      <div>{PROJECTS.map((project,index) => (
        <div key={index} className='mb-8 flex flex-wrap lg:justify-center'>
          ...
          <img className='mb-6 rounded-lg' src={project.image} width={150} height={150} alt={project.title} />
          </motion.div>
          <motion.div 
          ...
          whileInView={{opacity:1, x:0}}
          initial={{opacity:0, x:100}}
          className='w-full max-w-xl lg:w-3/4 shadow-[3px_6px_0px_0px_#4bdad4] border p-2 rounded-xl'>
